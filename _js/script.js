...
var cc_basic_style = this_cc => {
    return `
            ...
            .chefcookie__box
            {
                font-size: ${15 + (this_cc.config.style.size - 3)}px;
                line-height:1.6;
                color:${this_cc.config.style.color_text ?? '#595f60'};
                width: 100%;
                margin: 0 auto;
            ...
            {
                color:inherit;
                transition: all ${this_cc.animationSpeed / 1000}s ease-in-out;
            ...
            {
                padding: 1em 0.5em;
                border: 2px solid ${this_cc.config.style.color_text ?? '#595f60'};
                font-weight: bold;
                display: block;
                color: inherit;
            ...
            ${
                this_cc.config.style.highlight_accept === undefined || this_cc.config.style.highlight_accept === true
                    ? `
            .chefcookie__button--accept
            {                
                background-color:${this_cc.config.style.color_highlight ?? this_cc.config.style.color ?? '#ff0000'};
            ...
            {
                color:${this_cc.config.style.color_background ?? '#eeeeee'};
            }
                `
                    : ``
            }
            .chefcookie__settings-container
            {
                height:0;
                overflow:hidden;
                transition: height ${this_cc.animationSpeed / 1000}s ease-out;
            }
            .chefcookie__groups
            {
            ...
            {
            ${
                this_cc.config.style.show_disabled_checkbox === undefined ||
                this_cc.config.style.show_disabled_checkbox === false
                    ? `display:none;`
            ...
            .chefcookie__group-checkbox-icon
            {
                ...
                width: 4em;
                height: 2em;
                background-color: ${this_cc.config.style.color_background ?? '#eeeeee'};
                border: 2px solid ${this_cc.config.style.color_text ?? '#595f60'};
                margin: 0;
                padding: 0;
                position: relative;
            ...
            .chefcookie__group-checkbox-icon:after
            {
                ...
                width: 50%;
                bottom: 0;
                box-shadow: 0 0 0px 1px ${this_cc.config.style.color_text ?? '#595f60'};
                background-color: ${this_cc.config.style.color_text ?? '#595f60'};
                transition: all ${this_cc.animationSpeed / 1000}s ease-in-out;
                border-radius: 50%;
            }
            .chefcookie__group-checkbox ~ *
            ...
            .chefcookie__script-checkbox-icon
            {
                ...
                height: 1.5em;
                background-color: ${this_cc.config.style.color_background ?? '#eeeeee'};
                border: 1px solid ${this_cc.config.style.color_text ?? '#595f60'};
                margin: 0;
                padding: 0;
                position: relative;
                border-radius: 2em;
            ...
            .chefcookie__script-description-content table td {
                border:1px solid ${this_cc.hexToRgbaStr(this_cc.config.style.color_text ?? '#595f60', 0.1)};
                padding: 0.3em 0.5em;
                vertical-align:top;
            }
            ...
            .chefcookie--overlay .chefcookie__group
            {
                ...
                background-color: rgba(${
                    this_cc.config.style.color_background != '' &&
                    ['#000', '#000000', 'black'].indexOf(this_cc.config.style.color_background) > -1
                        ? '255, 255, 255'
                        : '0, 0, 0'
                }, 0.05);
